                ...
                <div className="relative max-w-[900px] w-full text-white font-normal mx-auto flex items-center justify-between px-4 py-2 m-6 shadow-lg hover:shadow-2xl">
                  <div className="grid-flow-col-1 md:grid grid-cols-2 gap-y-10 gap-x-6 items-start max-md:py-10 ">
                    ...
                    <div className="sm:ml-6 xl:ml-0">
                      ...
                      <a href={article.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center h-9 text-sm font-semibold whitespace-nowrap px-3 focus:outline-none focus:ring-2 bg-gray-300 text-black hover:bg-black hover:text-white focus:ring-slate-500 mt-6 absolute bottom-5 right-4 ">
                        Read more
                        </a>
                      </div>
                    </div>
